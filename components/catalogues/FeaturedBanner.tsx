  ...
  return (
    <div className="relative bg-gray-900 rounded-2xl overflow-hidden mb-12 shadow-2xl">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center">
        {/* Content Side */}
        <div className="p-5 lg:p-8 md:p-12 md:w-3/5 flex flex-col justify-center text-left">
        ...
        {/* Image Side */}
        <div className="md:w-2/5 p-5 lg:p-8 md:p-12 flex justify-center md:justify-end items-center relative">
