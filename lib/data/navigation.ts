  ...
  { label: "HOME", href: "/" },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/products/asset-wildlife-protection",
        children: [
          { label: "Wildlife Protection Covers", href: "/products/asset-wildlife-protection/wildlife-protection-covers" },
          { label: "Overhead Line Covers", href: "/products/asset-wildlife-protection/overhead-line-covers" },
          { label: "Overhead Line Tubes", href: "/products/asset-wildlife-protection/overhead-line-tubes" },
          { label: "Busbar Sleeves", href: "/products/asset-wildlife-protection/busbar-sleeves" },
          { label: "Busbar Tape", href: "/products/asset-wildlife-protection/busbar-tape" },
        ],
      },
      {
